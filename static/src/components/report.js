...
export default class Report extends Component {
	...
	getTitle() {
		return nimo.createElement(`<div id="title" class="flex relative text-gray-500 font-light uppercase tracking-widest text-xs">
		...
		this.report = nimo.createElement(`<div class="card text-sm text-gray-700">
			<div class="flex justify-between mt-2 mb-4">
				...
				<div id="switch" class="inline-flex border border-gray-500 rounded bg-gray-200">
					<div id="pageviews" class="label px-4 py-1 text-xs text-gray-800">PageViews</div>
					<div id="referrer" class="label px-4 py-1 text-xs text-gray-800 cursor-pointer">Referers</div>
					<div id="browser" class="label px-4 py-1 text-xs text-gray-800 cursor-pointer">Browser</div>
				</div>
			</div>
			<div id="report-area">
			</div>
