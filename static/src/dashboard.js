...
export default class DashboardWidget {
	...
	setup_container() {
		this.dashboard = nimo.createElement(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
			<div class="border border-gray-500 hover:border-gray-800 rounded py-2 px-4">
				<div class="label text-xs text-gray-800">Unique Visitors</div>
				<div class="flex items-end justify-between">
					<span id="uniqueVisitors" class="font-semibold text-3xl -mb-1">3.6 K</span>
			...
			<div class="border border-gray-500 hover:border-gray-800 rounded py-2 px-4">
				...
				<div class="flex items-end justify-between">
					<span id="pageViews" class="font-semibold text-3xl -mb-1">23.4 K</span>
			...
			<div class="border border-gray-500 hover:border-gray-800 rounded py-2 px-4">
				...
				<div class="flex items-end justify-between">
					<span id="averageTimeOnSite" class="font-semibold text-3xl -mb-1">05:24</span>
			...
			<div class="border border-gray-500 hover:border-gray-800 rounded py-2 px-4">
				...
				<div class="flex items-end justify-between">
					<span id="bouncRate" class="font-semibold text-3xl -mb-1">68%</span>
				</div>
			</div>
		</div>`);
